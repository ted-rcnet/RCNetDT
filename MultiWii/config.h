...
/*************************************************************************************************/
  ...
  /****************************    Middlecommand       *******************************/
    /* This is the value for smooth althold routine and failsafe_rth at which
	   the copter is stable in altitude */
  ...
  /**************************************************************************************/
      ...
      /* By default, the configuration is -> RCNet FC alone
         Uncomment the next line to activate The GPS/Mag Addon */
         
    //#define FC_GPS       // RCNet FC with MPU6050 + MS561101BA + HMC5883L + UBLOX GPS http://www.rcnet.com
  ...
  /**************************************************************************************/
    ...
    /*********************    Lowpass filter for some gyros    ****************************/
      ...
      /* MPU6050 Low pass filter setting. In case you cannot eliminate all vibrations to the Gyro, you can try
         ...
         Change low pass filter setting may changes PID behaviour, so in some cases retune your PID's after changing LPF. */
      //#define MPU6050_LPF_256HZ     // This is the default setting, no need to uncomment, just for reference
      //#define MPU6050_LPF_188HZ
      #define MPU6050_LPF_98HZ      // Default setting by RCNet DevTeam, give great result on F450/TBS and others popular frames
...
/*************************************************************************************************/
  ...
  /********                          Failsafe settings                 ********************/
    ...
    //#define FAILSAFE_RTH			      // Try to RTH when failsafe
  ...
  /**************************************************************************************/
    ...
    #define NAV_ALT_CTRL               true      // true - when activating rth, go to NAV_RTH_ALTITUDE before returning to home
    #define NAV_RTH_ALTITUDE           2000      // In cms, by default : 20 meters
    #define NAV_DESCENT_SPEED		100	 // 100 corresponds aproximatively to 50cm/s increase this number to make it descend faster
    
    /* Get your magnetic decliniation from here : http://magnetic-declination.com/
       To have help in french http://www.rcnet.com/demande-aide-f38/declinaison-magnetique-bizard-t1191.html?hilit=declination#p18680
    ...
    #define SMOOTH_GPS_HOLD        1   	     // Smoothen the GPS poshold when velocity not null
    #define SMOOTH_GPS_RATIO       3         // Divide calculated angle by this value during the activation time
  ...
  /********************************************************************/
    ...
    //#define RX_RSSI_PIN A9 /* PIN ROLL Conseillé en PPM-SUM car ainsi le cable PPM et le RSSI sont l'un a coté de l'autre */
...
/*************************************************************************************************/
  ...
  /********************************************************************/
	...
	#define SDCARD_MISSION		  // Mission controlled by a file on SDCARD
	#define SDCARD_LOGGER		  // Logging of permlog and gps if available
